...
MODEL_URL = 'https://storage.googleapis.com/capstonegacor-bucket/model-in-prod/model.h5'
...
async def predict(image: UploadFile = File(...)):
    ...
    print(class_idx)
    return JSONResponse(content={"class": int(class_idx), "data": classOutput[int(class_idx)]})
